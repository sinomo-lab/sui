...
2. [crate-architecture.md](./crate-architecture.md) for crate ownership and dependency boundaries.
3. [renderer-architecture.md](./renderer-architecture.md) for scene, compositor, and renderer details.
4. [testing.md](./testing.md) for headless tests, desktop harness tests, and visual artifacts.
5. [design.md](./design.md) for the long-term product and API direction.
