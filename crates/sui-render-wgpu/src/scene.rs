...
pub(crate) fn plan_retained_tile_upload(
...
pub(crate) fn rebuild_retained_tile_geometry(
...
pub(crate) fn upload_retained_tile_bytes(
    shared: &SharedRenderer,
...
pub(crate) fn grow_retained_tile_vertex_capacity(current: usize, required: usize) -> usize {
    if required == 0 {
        return current;
    }
