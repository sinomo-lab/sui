...
fn main() -> Result<()> {
    ...
    println!("Example passed: filled the name field and observed the Saved status.");
    Ok(())
}
...
impl Widget for ExampleRoot {
    ...
    fn semantics(&self, ctx: &mut SemanticsCtx) {
        ...
        root.name = Some("SUI Testing Example".to_string());
        ctx.push(root);
...
impl Widget for SaveButton {
    ...
    fn semantics(&self, ctx: &mut SemanticsCtx) {
        ...
        button.description = Some("Persist the current form".to_string());
