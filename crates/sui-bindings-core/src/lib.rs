...
pub fn binding_icon_glyph_from_name(value: &str) -> Option<IconGlyph> {
    match normalize_binding_name(value).as_str() {
        ...
        "messagessquare" => Some(IconGlyph::MessagesSquare),
        "cloudy" => Some(IconGlyph::Cloudy),
        "history" => Some(IconGlyph::History),
        "folder" => Some(IconGlyph::Folder),
        "folders" => Some(IconGlyph::Folders),
        ...
        "settings" => Some(IconGlyph::Settings),
...
pub fn binding_icon_glyph_name(glyph: IconGlyph) -> &'static str {
    match glyph {
        ...
        IconGlyph::Chat => "chat",
        IconGlyph::MessagesSquare => "messages-square",
        IconGlyph::Cloudy => "cloudy",
        IconGlyph::History => "history",
        IconGlyph::Folder => "folder",
        IconGlyph::Folders => "folders",
        IconGlyph::File => "file",
